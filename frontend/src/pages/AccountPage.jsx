...
function AccountPage() {
    ...
    const handleFollow = async () => {
        const response = await fetch(`/user/follow/${userData._id}`, {
            method: 'POST',
            headers: {
    ...
    return (
        ...
        <div className="flex h-80">
            <div className='flex flex-col w-1/3 items-center'>
                <img src={`http://localhost:4000/pfp/${userData.pfp}`} alt='pfp' className='h-48 w-48 object-cover my-5 rounded-full'/>
