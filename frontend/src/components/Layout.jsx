        ...
        <div className="flex h-screen overflow-hidden dark:text-white dark:bg-stone-900">
            ...
            <div className="side w-1/3 sticky top-0 flex flex-col">
                <div className='flex h-16 shrink-0 items-center py-2 px-2'>
                    ...
                    {user ? (
                        <>
                        <Link className='h-full m-2 flex items-center justify-center' to={`/user/${curUser._id}`}><img src={`${process.env.REACT_APP_API_URL}/pfp/${curUser.pfp}`} alt='pfp' className='h-7 w-7 object-cover rounded-full'/></Link>
